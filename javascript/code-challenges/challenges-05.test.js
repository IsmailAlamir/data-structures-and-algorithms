...
const addValues = (arr) => {
  // Solution code here...
  let value =arr.reduce((acc,val)=> acc+val,0);
return value
};
...
const addPurchases = (arr) => {
  // Solution code here...
   let value = arr.reduce((acc,val)=>acc +val.purchasePrice ,0)
   return value
};
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  let value = arr.reduce((acc,val )=> val,0)
  return value
};
...
const reversedString = (str) => {
  // Solution code here...
  let arr = str.split('');
  let reverse = arr.reduce((acc,val)=>{ 
    return val+acc },'' );
